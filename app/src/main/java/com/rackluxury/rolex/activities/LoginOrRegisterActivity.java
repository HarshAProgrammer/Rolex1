...
public class LoginOrRegisterActivity extends AppCompatActivity implements
    ...
    public void login(View view) {
        finish();
        startActivity(new Intent(LoginOrRegisterActivity.this, com.rackluxury.rolex.activities.LoginActivity.class));
    ...
    public void getStarted(View view) {
        finish();
        startActivity(new Intent(LoginOrRegisterActivity.this, com.rackluxury.rolex.activities.RegistrationActivity.class));
