...
public class RegistrationActivity extends AppCompatActivity implements
    ...
    private void sendUserData() {
        ...
        // Check if the imagePath is null or not before proceeding with the upload
        if (imagePath != null) {
            // Constructing image reference path in Firebase Storage
            ...
            // Handle the case where imagePath is null (e.g., no image selected)
//            Toasty.error(RegistrationActivity.this, "Please select a profile picture!", Toast.LENGTH_LONG).show();
            return; // Exit the method since we cannot proceed without a profile picture
        }

        // Assuming this is the part where you store user profile information in the Realtime Database
        // Note: This will execute even if the image upload fails, you might want to reconsider this logic
